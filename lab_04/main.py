...
class Visual(QtWidgets.QMainWindow, design.Ui_MainWindow):
    ...
    def draw_circle(self, x_center, y_center, radius):
        if self.radioButtonParamYr.isChecked():
            self.paramCircle(x_center, y_center, radius)
        elif self.radioButtonKanonYr.isChecked():
            self.canonCircle(x_center, y_center, radius)
        elif self.radioButtonBres.isChecked():
            self.bresCircle(x_center, y_center, radius)
        elif self.radioButtonSredToch.isChecked():
            self.midPointCircle(x_center, y_center, radius)
        else:
    ...
    def paramCircle(self, x_center, y_center, radius):
        step = 1 / radius
    ...
    def canonCircle(self, x_center, y_center, radius):
    ...
    def bresCircle(self, x_center, y_center, radius):
        x = 0
        y = radius
        d = 2 * (1 - radius)
        limit = round(radius / sqrt(2))
    ...
    def midPointCircle(self, x_center, y_center, radius):
        x = radius
        y = 0
        d = 1 - radius
        while x >= y:
